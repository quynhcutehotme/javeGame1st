...
public class bot extends entity {
    ...
    public void update() {
        ...
        switch (currentState) {
            ...
            case CHASE:
                ...
                setDirectionToward(dx, dy);
                // Add randomness to chase direction (20% chance to flip)
            ...
            case SEARCH:
                ...
                setDirectionToward(lastPlayerX - worldX, lastPlayerY - worldY);
                break;
        }
	...
	public void updateAI(int playerWorldX, int playerWorldY) {
		// This method is called from gamePanel with player coordinates
		// The existing update() method already handles AI logic using gp.player
		// So we just call update() which has all the AI logic
		update();
	}
}